...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.pbtn_GenarateKey.clicked.connect(self.call_api_gen_keys)
        self.ui.pbtn_Encrypt.clicked.connect(self.call_api_encrypt)
        self.ui.pbtn_Decrypt.clicked.connect(self.call_api_decrypt)
        self.ui.pbtn_Sign.clicked.connect(self.call_api_sign)
        self.ui.pbtn_Verify.clicked.connect(self.call_api_verify)
